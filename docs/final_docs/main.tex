...
Se utilizó Proximal Policy Optimization (PPO) con arquitecturas de redes neuronales recurrentes (LSTM) para entrenar políticas individuales de manera independiente en cuatro niveles de dificultad progresiva: Easy (5 agentes, 20 parches), Medium (10 agentes, 18 parches), Hard (10 agentes, 15 parches) y Expert (12 agentes, 10 parches). Los datos se generaron mediante simulaciones en entornos PettingZoo con espacios de observación de 13 dimensiones y 5 acciones discretas. El entrenamiento empleó normalización vectorizada y funciones de recompensa multiobjetivo que balancean forrajeo con comportamientos de flocking.
