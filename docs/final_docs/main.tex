...
\caption{Visualización del entorno en Easy Mode. Se observan 5 agentes (puntos de colores) explorando 20 parches de recursos (círculos verdes) en un mundo 20×20. Los agentes mantienen cohesión grupal mientras forrajean eficientemente.}
\label{fig:easy_mode_screenshot}
\end{figure}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../../exports/easy_evaluation.json_fig1_metrics_boxplot.png} &
\includegraphics[width=0.48\textwidth]{../../exports/medium_evaluation.json_fig1_metrics_boxplot.png} \\
\small (a) Easy Mode & \small (b) Medium Mode \\[0.5cm]
\includegraphics[width=0.48\textwidth]{../../exports/hard_evaluation.json_fig1_metrics_boxplot.png} &
\includegraphics[width=0.48\textwidth]{../../exports/expert_evaluation.json_fig1_metrics_boxplot.png} \\
\small (c) Hard Mode & \small (d) Expert Mode \\
\end{tabular}
\caption{Distribución de métricas clave (eficiencia, intake, Gini, polarización) para los cuatro niveles de dificultad. Se observa mayor variabilidad en niveles de escasez.}
\label{fig:metrics_boxplot_all}
\end{figure}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../../exports/easy_evaluation.json_fig2_performance_tiers.png} &
\includegraphics[width=0.48\textwidth]{../../exports/medium_evaluation.json_fig2_performance_tiers.png} \\
\small (a) Easy Mode & \small (b) Medium Mode \\[0.5cm]
\includegraphics[width=0.48\textwidth]{../../exports/hard_evaluation.json_fig2_performance_tiers.png} &
\includegraphics[width=0.48\textwidth]{../../exports/expert_evaluation.json_fig2_performance_tiers.png} \\
\small (c) Hard Mode & \small (d) Expert Mode \\
\end{tabular}
\caption{Distribución de episodios por tier de performance en los cuatro niveles. Se observa desplazamiento hacia tiers inferiores conforme aumenta la escasez de recursos.}
\label{fig:performance_tiers_all}
\end{figure}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../../exports/hard_evaluation.json_fig3_efficiency_vs_gini.png} &
\includegraphics[width=0.48\textwidth]{../../exports/expert_evaluation.json_fig3_efficiency_vs_gini.png} \\
\small (a) Hard Mode & \small (b) Expert Mode \\
\end{tabular}
\caption{Relación entre eficiencia y coeficiente de Gini en Hard y Expert modes. Se observa correlación negativa: mayor eficiencia tiende a asociarse con menor desigualdad.}
\label{fig:efficiency_vs_gini}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../../exports/baseline_boids_test.json_fig2_efficiency_histogram.png}
\caption{Distribución de eficiencia del Baseline Clásico de Boids en Easy Mode. Se observa concentración extrema cerca del 100\% con varianza mínima, demostrando que reglas fijas bien calibradas son óptimas en abundancia.}
\label{fig:baseline_efficiency_histogram}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../../exports/baseline-mode-ss.png}
\caption{Visualización del Baseline Clásico de Boids en Easy Mode. Los agentes (puntos de colores) exhiben comportamiento determinista con distribución uniforme y cohesión perfecta, resultado de reglas fijas bien calibradas.}
\label{fig:baseline_mode_screenshot}
\end{figure}
...
\centering
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../../exports/hard_evaluation.json_fig10_agent_trajectories.png} &
\includegraphics[width=0.48\textwidth]{../../exports/expert_evaluation.json_fig10_agent_trajectories.png} \\
\small (a) Hard Mode & \small (b) Expert Mode \\
\end{tabular}
\caption{Trayectorias de agentes en Hard y Expert modes. Se observan patrones de división dinámica de grupos (flock splitting), rotación eficiente entre parches, y exploración coordinada del espacio bajo condiciones de escasez.}
\label{fig:agent_trajectories_hard_expert}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../../exports/expert-mode-ss.png}
\caption{Visualización de Expert Mode bajo escasez extrema (12 agentes, 10 parches, ratio 1.2:1). Se observa dispersión dinámica de agentes, flock splitting para reducir competencia, y adaptación a densidad de recursos limitados en un mundo 35×35.}
\label{fig:expert_mode_screenshot}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{../../exports/expert_evaluation.json_fig4_rolling_mean.png}
\caption{Media móvil de eficiencia en Expert Mode (ventana de 10 episodios). Se observa estabilización de la política entrenada con varianza controlada, demostrando robustez del aprendizaje.}
\label{fig:rolling_mean_expert}
\end{figure}
...
Todo el código fuente, configuraciones, modelos entrenados y resultados están disponibles públicamente:

\begin{verbatim}
https://github.com/enriquegomeztagle/multi-agent-flocking-foraging-rl
\end{verbatim}

\subsection{Recursos Adicionales}

\textbf{Dashboard Interactivo:}

El dashboard de visualización de resultados está desplegado y accesible públicamente en:

\begin{verbatim}
http://54.165.139.51:8502
\end{verbatim}

El dashboard permite explorar interactivamente todas las métricas, distribuciones y análisis estadísticos de los cuatro niveles de dificultad (Easy, Medium, Hard, Expert) y el baseline de Boids.

\textbf{Gráficas Completas:}

Todas las visualizaciones generadas (50+ gráficas en alta resolución) están disponibles en el repositorio:

\begin{verbatim}
https://github.com/enriquegomeztagle/multi-agent-flocking-foraging-rl/tree/main/exports
\end{verbatim}

Este directorio incluye:
\begin{itemize}
    \item Boxplots de métricas por nivel
    \item Distribuciones de performance (tiers)
    \item Análisis de eficiencia vs. equidad (Gini)
    \item Medias móviles y desviaciones estándar
    \item Cambios episodio-a-episodio
    \item Trayectorias de agentes
    \item Cuartiles de eficiencia
    \item Tasas de éxito
\end{itemize}
