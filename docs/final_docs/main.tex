...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{../../exports/easy_evaluation.json_fig10_agent_trajectories.png}
\caption{Trayectorias de agentes en Easy Mode. Se observan patrones de exploración coordinada y visitas recurrentes a parches de recursos.}
\label{fig:agent_trajectories_easy}
\end{figure}
