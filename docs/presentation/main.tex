...
\begin{columns}
    \begin{column}{0.55\textwidth}
        \begin{itemize}
            ...
            \begin{itemize}
                \item Stock $S(t) \in [0, S_{\max}]$.
                \item Regeneración logística:
                \[
                    \frac{dS}{dt} = r S \left(1 - \frac{S}{S_{\max}}\right)
                \]
            \end{itemize}
        \end{itemize}
    \end{column}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Dashboard interactivo (Streamlit): \\
        \hrefcol{http://54.165.139.51:8502}{http://54.165.139.51:8502}
    \end{itemize}
\end{itemize}
\end{frame}
