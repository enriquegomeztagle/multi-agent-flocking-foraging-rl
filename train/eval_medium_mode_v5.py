...
# Medium Mode Configuration V5 (HARDER - from env_medium_mode_v5_harder.yaml)
MEDIUM_CONFIG = {
    "n_agents": 10,
    "n_patches": 15,        # V5: 15 patches (harder than V4's 18)
    "width": 28.0,          # V5: 28x28 world (harder than V4's 23x23)
    "height": 28.0,         # V5: 28x28 world
    "episode_len": 2500,
    "feed_radius": 3.5,     # V5: 3.5 (harder than V4's 3.8)
    "c_max": 0.070,         # V5: 0.070 (harder than V4's 0.077)
    "S_max": 2.5,           # V5: 2.5 (harder than V4's 2.8)
    "regen_r": 0.32,        # V5: 0.32 (harder than V4's 0.37)
    "k_neighbors": 6,
    "v_max": 1.35,
    "a_max": 0.18,
    "turn_max": 0.28,
...
# Theoretical maximum: 10 agents × 2500 steps × 0.070 c_max = 1750 total
...
def evaluate_model(model_path: str, n_episodes: int = 100, vecnormalize_path: str = None):
    ...
    """
    print("==" * 40)
    print("EVALUATION: RL MODEL ON MEDIUM MODE V5 (HARDER)")
    print("==" * 40)
    print()
    print(f"Model: {model_path}")
    print(f"Configuration: Medium Mode V5 (10 agents, 15 patches, 28×28 world)")
